...
<head>
  ...
  <!-- Site Metas -->
  <title>E-bharatBazar</title>
  <meta name="keywords" content="">
  <meta name="description" content="">
  <meta name="author" content="">

  <!-- Site Icons -->
  <link rel="shortcut icon" href="{{ asset('front_assets/imagesfavicon.ico')}}" type=" image/x-icon">
...
<body>
  ...
  @include('Ebharatbazar.layouts.header')
  @yield('content')
  @include('Ebharatbazar.layouts.footer')
